...
from sccl.modeling.roi_heads.fast_rcnn import FastRCNNFocaltLossOutputLayers
...
class StandardROIHeadsPseudoLab(StandardROIHeads):
    ...
    def _forward_box(self, features: Dict[str, torch.Tensor], proposals: List[Instances], branch: str = ""):
        ...
        if self.training and branch == "source":
    ...
    # Hungarian algorithm to find the one-to-one assignment of source and target centers.

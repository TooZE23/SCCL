...
from sccl_st.data.common import (
    AspectRatioGroupedSemiSupDataset,
...
# uesed by semi-supervised trainer without augmentation crops
def build_detection_semisup_train_loader_no_crop(cfg, mapper=None):
    if cfg.DATASETS.CROSS_DATASET:  # cross-dataset (e.g., coco-additional)
        label_dicts = get_detection_dataset_dicts(
            cfg.DATASETS.TRAIN_LABEL,
            filter_empty=cfg.DATALOADER.FILTER_EMPTY_ANNOTATIONS,
...
# batch data loader (no augmentation crops)
